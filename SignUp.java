...
public class SignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //If the instance is already created, then we don't need to log in again. That is when the user forgot to log out.
...
public void onComplete(@NonNull Task<Void> task) {
        ...
        Toast.makeText(SignUp.this, getString(R.string.registrationunsuccesful),Toast.LENGTH_LONG).show();
        }
        });
